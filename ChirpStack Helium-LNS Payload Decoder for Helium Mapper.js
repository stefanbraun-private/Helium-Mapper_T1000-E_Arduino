// Payload Decoder for custom Helium Mapper based on Seeed Studio T1000-E
// BrS, April 19th 2025
// based on CayenneLPP decoder of RAKwireless
// from https://github.com/RAKWireless/RAKwireless_Standardized_Payload/blob/main/RAKwireless_Standardized_Payload.js
...
function decodeUplink(input) {
	var orig = Decode(input.fPort, input.bytes, input.variables);
	var data = {}; 
	data['latitude'] = orig['gps_1']['latitude'];
	data['longitude'] = orig['gps_1']['longitude'];
	data['altitude'] = orig['gps_1']['altitude'];
	data['accuracy'] = 10;
	
	data['battery'] = orig['capacity_batt_2'];
	return {data};
}
