...
//
// BrS, April 19th 2025: added high precision GPS location (LPP-ID 137)
...
#define LPP_GPS_HIGHPREC 137        // 4 byte lon/lat 0.000001 °, 3 bytes alt 0.01 meter
#define LPP_CAPACITY_BATT 184       // 1 byte, 1 % unsigned
...
#define LPP_GPS_HIGHPREC_SIZE 13       // 4 byte lon/lat 0.000001 °, 3 bytes alt 0.01 meter
#define LPP_CAPACITY_BATT_SIZE 3       // 1 byte, 1 % unsigned
...
public:
  ...
  uint8_t addGPS_highPrec(uint8_t channel, float latitude, float longitude, float meters);
  uint8_t addCapacityBattery(uint8_t channel, uint8_t percent);
